...
from open_r1.vlm_modules.qwen_module import evaluate_answer_similarity
...
class InvernVLModule(VLMBaseModule):
    ...
    def format_reward_gen(completions, **kwargs):
        """Check if model output has <think> and <answer> tags."""
        import os
        from datetime import datetime
    ...
    def llm_reward(completions, solution, **kwargs):
        """General accuracy reward using sentence similarity."""
    ...
    def select_reward_func(func: str, task_type: str):
        if func == "accuracy":
            match task_type:
                ...
                case "general":
                    return InvernVLModule.llm_reward
                case _:
            ...
            match task_type:
                ...
                case "general":
                    return InvernVLModule.format_reward_gen
                case _:
                    raise ValueError(f"Unsupported reward function: {func}")
        else:
            raise ValueError(f"Unsupported reward function: {func}")
